...
class ConnectSpec extends ChiselPropSpec with Utils {
  property("SInt := FixedPoint should fail") {
    intercept[ChiselException] {
      extractCause[ChiselException] {
        ChiselStage.convert { new CrossConnectTester(FixedPoint(16.W, 8.BP), UInt(16.W)) }
      }
    }
  }
  ...
  property("FixedPoint := SInt should fail") {
    intercept[ChiselException] {
      extractCause[ChiselException] {
        ChiselStage.convert { new CrossConnectTester(SInt(16.W), FixedPoint(16.W, 8.BP)) }
      }
    }
  }
  property("FixedPoint := UInt should fail") {
    intercept[ChiselException] {
      extractCause[ChiselException] {
        ChiselStage.convert { new CrossConnectTester(UInt(16.W), FixedPoint(16.W, 8.BP)) }
      }
    }
  }
  property("Analog := FixedPoint should fail") {
    intercept[ChiselException] {
      extractCause[ChiselException] {
        ChiselStage.convert { new CrossConnectTester(Analog(16.W), FixedPoint(16.W, 8.BP)) }
      }
    }
  }
  property("FixedPoint := Analog should fail") {
    intercept[ChiselException] {
      extractCause[ChiselException] {
        ChiselStage.convert { new CrossConnectTester(FixedPoint(16.W, 8.BP), Analog(16.W)) }
      }
    }
  }
}
